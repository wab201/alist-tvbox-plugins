...
| 源码文件 | `py/豆瓣TMDB追更单入口_v69.py` |
| 源码大小 | `616507` 字节 |
| 源码 SHA256 | `7D089371708F3E236690EF87CEAED372D0B36A55A790BBA138032A2755342D12` |
| 自动化回归 | `284` 项通过（含 V69 追更详情本地元数据与统一截止时间回归） |
...
| 仓库部署 | V69 待正式仓库导入与 Android 虚拟机联调；V68/V67 均保留为直接回退版本 |
