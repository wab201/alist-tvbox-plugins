...
| 源码文件 | `py/豆瓣TMDB追更单入口_v68.py` |
| 源码大小 | `614228` 字节 |
| 源码 SHA256 | `F25AB0774896F7EDB513A8BE2C3F71C7E97BD74E90A96A0736E8C84F7EC2AD3A` |
| 自动化回归 | `282` 项通过（含 V68 完整线路优先、跨接口去重和缺集提示回归） |
...
| 仓库部署 | V68 待正式仓库导入与 Android 虚拟机联调；V67 保留为直接回退版本 |
