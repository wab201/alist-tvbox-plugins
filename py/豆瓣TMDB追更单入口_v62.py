    ...
    def _ready_resource_detail(self, raw_id, item, base_vod):
        ...
        for row in self._ready_resource_rows(item):
            ...
            if refreshed:
                ...
                # A remembered route that cannot be re-issued is stale. Let
                # the normal detail path search replacement resources instead
                # of presenting a known-dead bound route.
                continue
            rewritten = self._rewrite_resource_vod(
